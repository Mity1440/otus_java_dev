...
public abstract class AbstractHibernateTest {
    ...
    protected DBServiceClient dbServiceClientWithCashe;
    ...
    public void setUp() {
        ...
        var cash = new MyCache<Long, Client>();
        dbServiceClientWithCashe = new DbServiceClientWithCasheImpl(transactionManager, clientTemplate, cash);
